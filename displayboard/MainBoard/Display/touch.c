...
void Hard_Screen_Addr(u16 hx,u16 hy,u16* sx,u16* sy)
{
	u16 mx,my;
...
//	TP_Init();
	...
	{
		Hard_Screen_Addr(tp_dev.x,tp_dev.y,&Touch_X,&Touch_Y);
		
		mMaininf.mMode.mKeyPressFlag = 1;
//		mMaininf.mMode.mScreenPressFlag = 1;
	}
	else                                //触摸屏松开
	{
		if(mMaininf.mMode.mKeyPressFlag == 1)
		{
			mMaininf.mMode.mScreenPressFlag = 1;
		}
